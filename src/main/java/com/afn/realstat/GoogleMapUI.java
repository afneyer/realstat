...
public class GoogleMapUI extends UI {
	...
	protected void init(VaadinRequest request) {
		...
		Button addMarkerToMaariaButton = new Button("Open Maaria Window", new Button.ClickListener() {
			@Override
		...
		componentToMaariaInfoWindowButton = new Button("Add component to Maaria window", new Button.ClickListener() {
			@Override
			public void buttonClick(ClickEvent clickEvent) {
